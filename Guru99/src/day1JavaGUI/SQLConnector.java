 ...
 * dbUrl = "jdbc:mysql://localhost:3036/emp";
 * 
 * //Database Username String username = "root";
 * 
 * //Database Password String password = "sAtru8h@n";
 * 
 * //Query to Execute String query = "select *  from employee;";
 * 
 ...
 * (rs.next()){ String myName = rs.getString(1); String myAge = rs.getString(2);
 * System. out.println(myName+"  "+myAge); } // closing DB Connection
 * con.close();
 * 
 * }
 * 
